...
enum {
    ...
    INPUT_GIMBAL_PITCH,
    INPUT_GIMBAL_ROLL,
    INPUT_STEWART_PLATFORM_1,
    INPUT_STEWART_PLATFORM_2,
    INPUT_STEWART_PLATFORM_3,
    INPUT_STEWART_PLATFORM_4,
    INPUT_STEWART_PLATFORM_5,
    INPUT_STEWART_PLATFORM_6,
    INPUT_SOURCE_COUNT
} inputSource_e;
...
typedef enum {
    ...
    SERVO_STEWART_PLATFORM_1 = 0,
    SERVO_STEWART_PLATFORM_2 = 1,
    SERVO_STEWART_PLATFORM_3 = 2,
    SERVO_STEWART_PLATFORM_4 = 3,
    SERVO_STEWART_PLATFORM_5 = 4,
    SERVO_STEWART_PLATFORM_6 = 5
